...
def tests():
    ...
    intcode.test_inout([3,9,8,9,10,9,4,9,99,-1,8], [9], [0], "0 if not equal to 8")
    intcode.test_inout([3,3,1108,-1,8,3,4,3,99], [8], [1], "1 if equal to 8")
    intcode.test_inout([3,3,1108,-1,8,3,4,3,99], [9], [0], "0 if not equal to 8")
    intcode.test_inout([3,9,7,9,10,9,4,9,99,-1,8], [7], [1], "1 if lt 8")
    intcode.test_inout([3,9,7,9,10,9,4,9,99,-1,8], [8], [0], "0 if not lt 8")
    intcode.test_inout([3,3,1107,-1,8,3,4,3,99], [7], [1], "1 if lt 8")
    intcode.test_inout([3,3,1107,-1,8,3,4,3,99], [8], [0], "0 if not lt 8")
    intcode.test_inout([3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9], [0], [0], "0 if 0")
    intcode.test_inout([3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9], [10], [1], "1 if not 0")
    intcode.test_inout([3,3,1105,-1,9,1101,0,0,12,4,12,99,1], [0], [0], "0 if 0")
    intcode.test_inout([3,3,1105,-1,9,1101,0,0,12,4,12,99,1], [10], [1], "1 if not 0")
    intcode.test_inout([3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,
